...
Place supplement product photos in this folder.

Filename must match the slug used in `health-reference.html`. When a brand changes, simply replace the image file with the same filename — no code changes needed.
